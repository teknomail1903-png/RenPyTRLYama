...
{
    /// <inheritdoc />
    public partial class UpdateSupportSystem : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // Drop old SupportTickets table if exists
            migrationBuilder.DropTable(
                name: "SupportTickets");

            // Create new SupportTickets table with updated structure
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsReadByUser = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
